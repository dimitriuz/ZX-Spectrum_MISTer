...
// on its own. WDOG_LIMIT (above) is budgeted well above a legitimate save: a
// Scorpion snapshot moves 262,280 bytes, and the default gives roughly 2^27
// clk_sys cycles (~1.2s at 112MHz). Counts only while ss_busy|ld_download is
